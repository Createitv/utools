  ...
  public open() {
    return new Promise<IDBDatabase>((resolve, reject) => {
      try {
        ...
        // If exist the same version database, there need upgrade an new
        // version database, because of the same version can't trigger
        // onupgradeneeded event which will occur object stores was not found
        // exception.
